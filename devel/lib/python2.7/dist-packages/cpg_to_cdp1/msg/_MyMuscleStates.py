...
"""autogenerated by genpy from cpg_to_cdp1/MyMuscleStates.msg. Do not edit."""
import codecs
import sys
...
import cpg_to_cdp1.msg
import geometry_msgs.msg
import std_msgs.msg

class MyMuscleStates(genpy.Message):
  _md5sum = "68a8a94a76f8e57fa8ecb44dba7bb6da"
  _type = "cpg_to_cdp1/MyMuscleStates"
...
float64 y
float64 z"""
  __slots__ = ['header','muscles']
  _slot_types = ['std_msgs/Header','cpg_to_cdp1/MyMuscleState[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MyMuscleStates, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.muscles)
      buff.write(_struct_I.pack(length))
      for val1 in self.muscles:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cpg_to_cdp1.msg.MyMuscleState()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
